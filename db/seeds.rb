...
Match.create!([
  ...
  {day_id: 13,  stage_code: "GS", started_at: DateTime.civil(2022, 12, 02, 22, 00, 00, Rational(3, 24)), home_country_code: "CAM", away_country_code: "BRA", home_odds: 8.95, draw_odds: 5.05, away_odds: 1.33},
