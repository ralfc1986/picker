...
#   {code: "3P",name: "3rd Placing", weighting: 300},
#   {code: "FN",name: "Final", weighting: 350}  
# ])
...
# Match.find_or_create_by(day_id : "",  stage_code: "GS", started_at: DateTime.civil(2022, 11, 23, 22, 00, 00, Rational(3, 24)), home_country_code: "", away_country_code: "", home_odds: , draw_odds: , away_odds: )
...
Match.create!([
  ...
  {day_id: 3,  stage_code: "GS", started_at: DateTime.civil(2022, 11, 22, 22, 00, 00, Rational(3, 24)), home_country_code: "FRN", away_country_code: "AUS", home_odds: 1.21, draw_odds: 6.72, away_odds: 14.38},
  ...
  {day_id: 5,  stage_code: "GS", started_at: DateTime.civil(2022, 11, 24, 13, 00, 00, Rational(3, 24)), home_country_code: "SUI", away_country_code: "CAM", home_odds: 1.89, draw_odds: 3.36, away_odds: 4.62},
  ...
  {day_id: 7,  stage_code: "GS", started_at: DateTime.civil(2022, 11, 26, 19, 00, 00, Rational(3, 24)), home_country_code: "FRN", away_country_code: "DEN", home_odds: 1.95, draw_odds: 3.46, away_odds: 4.14},
  ...
  {day_id: 9,  stage_code: "GS", started_at: DateTime.civil(2022, 11, 28, 13, 00, 00, Rational(3, 24)), home_country_code: "CAM", away_country_code: "SRB", home_odds: 3.64, draw_odds: 3.07, away_odds: 2.26},
  ...
  {day_id: 11,  stage_code: "GS", started_at: DateTime.civil(2022, 11, 30, 18, 00, 00, Rational(3, 24)), home_country_code: "TUN", away_country_code: "FRN", home_odds: 14.20, draw_odds: 5.40, away_odds: 1.24},
  ...
  {day_id: 13,  stage_code: "GS", started_at: DateTime.civil(2022, 12, 02, 22, 00, 00, Rational(3, 24)), home_country_code: "CAM", away_country_code: "BRA", home_odds: 9.28, draw_odds: 5.10, away_odds: 1.35},
  {day_id: 13,  stage_code: "GS", started_at: DateTime.civil(2022, 12, 02, 22, 00, 00, Rational(3, 24)), home_country_code: "SRB", away_country_code: "SUI", home_odds: 2.77, draw_odds: 3.37, away_odds: 2.48},
